...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credential("ashimwe","gmail","gmail3")
    ...
    def test_init(self):
        ...
        '''
        self.assertEqual( self.new_credential.user_password, "ashimwe")
        self.assertEqual( self.new_credential.credential_name, "gmail" )
        self.assertEqual( self.new_credential.credential_password, "gmail3" )
    ...
    def test_save_multiple_credentials(self):
        ...
        test_credential = Credential("ashimwe","gmail","gmail3")
    ...
    def test_display_credential(self):
        ...
        self.assertEqual( len(Credential.display_credential("ashimwe")) , 2 )
