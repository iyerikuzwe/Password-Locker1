...
class TestCredential(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_credential = Credential("Twitter","nicolash","4321")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.user_name,"nicolash")
    ...
    def test_save_multiple_credentials(self):
        ...
        """
        self.new_credential.save_credential()
        test_credential=Credential("Facebook","niniashil","09876")
